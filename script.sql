...
-- Clientes
INSERT INTO cliente (cpf, email, nome) VALUES (12345678909, 'joao_silva@gmail.com', 'Jo�o Pedro da Silva');
...
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('An�is de Cebola', 'An�is de cebola empanados', 'ACOMPANHAMENTO', 6.00);
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Nuggets de Frango', 'Por��o de nuggets de frango', 'ACOMPANHAMENTO', 7.00);
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Mandioca Frita', 'Por��o de mandioca frita', 'ACOMPANHAMENTO', 5.00);
...
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('�gua Mineral', '�gua mineral sem g�s 500ml', 'BEBIDA', 2.50);
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Ch� Gelado', 'Ch� gelado de lim�o 300ml', 'BEBIDA', 3.00);

-- Lanches
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Cheeseburger Bacon', 'Hamb�rguer com queijo e bacon', 'LANCHE', 12.00);
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Sandu�che de Frango', 'Sandu�che de frango grelhado', 'LANCHE', 10.00);
...
INSERT INTO produto (nome, descricao, categoria, preco) VALUES ('Torta de Ma��', 'Torta de ma�� com canela', 'SOBREMESA', 5.50);
